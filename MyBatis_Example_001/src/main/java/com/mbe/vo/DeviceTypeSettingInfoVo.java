 ...
 * Date:  2018/6/22.
 */
public class DeviceTypeSettingInfoVo extends BaseSearchVo<DeviceTypeSettingInfoVo> {
    private String id;
    ...
    public List<DeviceTypeSettingInfoVo> childList = new ArrayList<DeviceTypeSettingInfoVo>();

    public List<DeviceTypeSettingInfoVo> getChildList() {
        return childList;
    }

    public void setChildList(List<DeviceTypeSettingInfoVo> childList) {

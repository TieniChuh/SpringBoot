...
public class RoomSplitInfoVo {

    private List<RoominfoVo> oldroomlist;
    private List<RoominfoVo> newroomlist;

    public List<RoominfoVo> getOldroomlist() {
        return oldroomlist;
    }

    public void setOldroomlist(List<RoominfoVo> oldroomlist) {
        this.oldroomlist = oldroomlist;
    }

    public List<RoominfoVo> getNewroomlist() {
        return newroomlist;
    }

    public void setNewroomlist(List<RoominfoVo> newroomlist) {

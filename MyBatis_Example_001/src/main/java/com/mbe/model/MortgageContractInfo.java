 ...
 * Date:  2018/6/22.
 */
public class MortgageContractInfo {
    private String id;
    ...
    private List<PawnDetail> pawnDetailList;

    public List<PawnDetail> getPawnDetailList() {
        return pawnDetailList;
    }

    public void setPawnDetailList(List<PawnDetail> pawnDetailList) {
